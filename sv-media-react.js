...
(function () {
  ...
  function injectCss() {
    ...
    s.textContent = [
      ...
      "#server-view .sv-attachment-image{max-width:min(420px,100%);max-height:320px;border-radius:8px;display:block}",
      "#server-view .sv-attachment-video{max-width:min(420px,100%);max-height:320px;border-radius:8px;margin-top:6px}",
  ...
  function renderGifGrid(gifs) {
    ...
    grid.querySelectorAll(".sv-gif-cell").forEach(function (cell) {
      cell.addEventListener("click", function (e) {
        ...
        sendGif(cell.getAttribute("data-gif-url"));
      });
    });
  }
