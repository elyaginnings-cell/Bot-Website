    ...
    if (Array.isArray(p.panels)) {
      panels = p.panels
        ...
        .map((panel) => ({
          ...
          buttonLabel: String(panel.buttonLabel || p.buttonLabel || "Add roles").slice(0, 80),
          removeButtonLabel: String(
            panel.removeButtonLabel || p.removeButtonLabel || "Remove roles"
          ).slice(0, 80),
          embedTitle: String(panel.embedTitle || p.embedTitle || panel.name || "Self Roles").slice(
            0,
            256
          ),
          embedDescription: String(
            panel.embedDescription || p.embedDescription || ""
          ).slice(0, 2000),
    ...
    next.selfRoles = {
      ...
      buttonLabel:
        p.buttonLabel != null
          ...
          : cur.buttonLabel || "Add roles",
      removeButtonLabel:
        p.removeButtonLabel != null
          ? String(p.removeButtonLabel).slice(0, 80)
          : cur.removeButtonLabel || "Remove roles",
      embedTitle:
        p.embedTitle != null
